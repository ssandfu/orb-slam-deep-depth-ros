...
void Node::Init () {
  ...
  dynamic_reconfigure::Server<orb_slam_deep_depth_ros::dynamic_reconfigureConfig>::CallbackType dynamic_param_callback;
...
void Node::ParamsChangedCallback(orb_slam_deep_depth_ros::dynamic_reconfigureConfig &config, uint32_t level) {
...
bool Node::SaveMapSrv (orb_slam_deep_depth_ros::SaveMap::Request &req, orb_slam_deep_depth_ros::SaveMap::Response &res) {
...
void Node::LoadOrbParameters (ORB_SLAM2::ORBParameters& parameters) {
  ...
  if (sensor_== ORB_SLAM2::System::STEREO || sensor_==ORB_SLAM2::System::RGBD 
    ...
    node_handle_.param(name_of_node_ + "/nStereoDelay", parameters.nStereoDelay, static_cast<int>(-1));
    node_handle_.param(name_of_node_ + "/nKFEnhance", parameters.nKFEnhance, static_cast<int>(-1));
  }

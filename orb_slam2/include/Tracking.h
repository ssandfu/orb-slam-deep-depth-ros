...
public:
    ...
    cv::Mat GrabImageMonocularDepth_Stereo(const cv::Mat &imRectLeft, const cv::Mat &imRectRight, const double &timestamp);
...
public:
    ...
    //Use these two only in case of sensor::MONO_DEPTH
    Frame mCurrentFrame_Stereo;
    Frame mCurrentFrame_Monocular;
...
protected:
    ...
    // Map initialization for monocular with depth information
    void MonocularDepthInitialization();
